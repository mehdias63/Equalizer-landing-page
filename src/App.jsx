...
function App() {
  return (
    <main className="bg-[url(/images/bg-main-mobile.png)] min-h-screen md:bg-[url(/images/bg-main-tablet.png)] lg:bg-[url(/images/bg-main-desktop.png)] font-ibm relative max-w-[90rem] lg:px-[10rem] mx-auto">
      <img
